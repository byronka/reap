...
//  }
  ...
  public void loadFieldValues() {
    ...
    fieldValues.put(DatabaseAdapter.TOTAL_PURCHASE_VALUE,"0");
    fieldValues.put(DatabaseAdapter.YEARLY_INTEREST_RATE, "0");
    fieldValues.put(DatabaseAdapter.MONTHLY_INTEREST_RATE, "0");
    fieldValues.put(DatabaseAdapter.BUILDING_VALUE, "0");
    fieldValues.put(DatabaseAdapter.NUMBER_OF_COMPOUNDING_PERIODS, "360");
    fieldValues.put(DatabaseAdapter.INFLATION_RATE, "0");
    fieldValues.put(DatabaseAdapter.PRIMARY_MORTGAGE_INSURANCE_RATE, "0");
    fieldValues.put(DatabaseAdapter.DOWN_PAYMENT, "0");
    fieldValues.put(DatabaseAdapter.STREET_ADDRESS, "");
    fieldValues.put(DatabaseAdapter.CITY, "");
    fieldValues.put(DatabaseAdapter.STATE_INITIALS, "");
    fieldValues.put(DatabaseAdapter.ESTIMATED_RENT_PAYMENTS, "0");
    fieldValues.put(DatabaseAdapter.REAL_ESTATE_APPRECIATION_RATE, "0");
    fieldValues.put(DatabaseAdapter.YEARLY_ALTERNATE_INVESTMENT_RETURN, "0");
    fieldValues.put(DatabaseAdapter.YEARLY_HOME_INSURANCE, "0");
    fieldValues.put(DatabaseAdapter.PROPERTY_TAX_RATE, "0");
    fieldValues.put(DatabaseAdapter.LOCAL_MUNICIPAL_FEES, "0");
    fieldValues.put(DatabaseAdapter.VACANCY_AND_CREDIT_LOSS_RATE, "0");
    fieldValues.put(DatabaseAdapter.INITIAL_YEARLY_GENERAL_EXPENSES, "0");
    fieldValues.put(DatabaseAdapter.MARGINAL_TAX_RATE, "0");
    fieldValues.put(DatabaseAdapter.SELLING_BROKER_RATE, "0");
    fieldValues.put(DatabaseAdapter.GENERAL_SALE_EXPENSES, "0");
    fieldValues.put(DatabaseAdapter.REQUIRED_RATE_OF_RETURN, "0");
    fieldValues.put(DatabaseAdapter.FIX_UP_COSTS, "0");
    fieldValues.put(DatabaseAdapter.CLOSING_COSTS, "0");
  }
