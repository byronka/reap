...
public class MathCheckTests implements MathCheckInterface {
...
//  }
  ...
  public StringBuffer getBeforeTaxCashFlow(StringBuffer s, int year) {
    // cashflowIn - cashflowOut
  ...
  public StringBuffer getYearlyOutlay(StringBuffer s, int year) {
    // cashflowIn - cashflowOut
