...
//  INITIAL_HOME_INSURANCE("Yearly home insurance", ValueType.CURRENCY, true, false, string.initialHomeInsuranceHelpText, string.initialHomeInsuranceTitleText),
...
//  MONTHLY_RENT_FV ("Monthly rent future value", ValueType.CURRENCY, false, true, string.monthlyRentFVHelpText, string.monthlyRentFVTitleText),
...
//  YEARLY_BEFORE_TAX_CASH_FLOW("Yearly before tax cash flow", ValueType.CURRENCY, false, true, string.yearlyBeforeTaxCashFlowHelpText, string.yearlyBeforeTaxCashFlowTitleText),
...
//  YEARLY_HOME_INSURANCE("Yearly home insurance", ValueType.CURRENCY, false, true, string.yearlyHomeInsuranceHelpText, string.yearlyHomeInsuranceTitleText),
...
//  YEARLY_MUNICIPAL_FEES ("Yearly municipal fees", ValueType.CURRENCY, false, true, string.yearlyMunicipalFeesHelpText, string.yearlyMunicipalFeesTitleText),
//  YEARLY_OUTLAY ("Yearly outlay", ValueType.CURRENCY, false, true, string.yearlyOutlayHelpText, string.yearlyOutlayTitleText),
