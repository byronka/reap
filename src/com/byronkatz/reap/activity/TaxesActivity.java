...
public class TaxesActivity extends Activity {
  ...
  public void onCreate(Bundle savedState) {
    ...
    Double totalPurchaseValue = dataController.getInputValue(ValueEnum.TOTAL_PURCHASE_VALUE);
  ...
  private void assignValuesToFields() {
    ...
    Double mtr = dataController.getInputValue(ValueEnum.MARGINAL_TAX_RATE);
    marginalTaxRate.setText(Utility.displayPercentage(mtr));
    
    Double bv = dataController.getInputValue(ValueEnum.BUILDING_VALUE);
    buildingValue.setText(Utility.displayCurrency(bv));
    
    Double ptr = dataController.getInputValue(ValueEnum.PROPERTY_TAX);
    propertyTax.setText(Utility.displayCurrency(ptr));
    
    Double lmf = dataController.getInputValue(ValueEnum.LOCAL_MUNICIPAL_FEES);
