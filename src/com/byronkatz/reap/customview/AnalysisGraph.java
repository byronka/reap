...
//  private Float maxX;
  ...
  public void onDraw(Canvas canvas) {
    ...
    if (! isInEditMode() ) {
      ...
      functionMinY = Collections.min(dataPoints).floatValue();
      functionMaxY = Collections.max(dataPoints).floatValue();
      functionMinX = MINIMUM_YEAR;
      functionMaxX = dataPoints.size();
      ...
      String currentValueNumerals = Utility.displayShortValue(
          dataController.getCalcValue(graphKeyValue, currentYearHighlighted*12), graphKeyValue);
